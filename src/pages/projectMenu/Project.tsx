...
const Project = () => {
  ...
  useEffect(() => {
    //fires on pageload, and then again once organizationID is found, and whenever searchValue changes
  ...
  const projectInitialization = async () => {
    ...
    if (organizationID) {
      ...
      let sortedProjects = projectListResponse?.projects.sort(
        (a: any, b: any) =>
          a.createdAt < b.createdAt ? 1 : a.createdAt > b.createdAt ? -1 : 0
      );

      if (searchValue)
        sortedProjects = sortedProjects.filter((project: any) =>
      ...
      setTimeout(() => {
        //provides an additional 3seconds for list to finish populating
    ...
    <div className=''>
      ...
      <div className=''>
        <div className='mt-4 w-full'>
          <TextInput
            // className='my-5 bg-white text-sm h-8 sticky border-none'
            className='text-xs rounded border-solid border-[1px] border-[#5E5E5E]'
            variant='box'
          ...
          <p className='p-2 font-bold'>Or Select a Project below:</p>
